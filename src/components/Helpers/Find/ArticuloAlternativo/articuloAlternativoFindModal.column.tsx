...
const useArticuloAlternativoFindColumn = (inputFocus: string): Column<IArticuloFindTable>[] => {
    ...
    () => [
      {
        ...
        Cell: ({ row }: { row: { original: IArticuloFindTable } }) => (
          <div className="button-base-container-center">
            <SelectButton
              modalProp="tercer"
              retorno={{ ...row.original, origen: "articuloAlternativoFind" } as IArticuloFind}
...
export default useArticuloAlternativoFindColumn;
