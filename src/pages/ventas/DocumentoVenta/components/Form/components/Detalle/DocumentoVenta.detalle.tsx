...
import { useDocumentoVentaDetalleColumn } from "../../../Column";

interface IProps {
  dataGeneral: IDocumentoVenta;
  setDataGeneral: React.Dispatch<React.SetStateAction<IDocumentoVenta>>;
  handleDataGeneral: (
    e: ChangeEvent<HTMLInputElement | HTMLSelectElement>
  ) => Promise<void> | void;
  adicional: IDocumentoVentaAdicional;
  handleAdicional: (
    e: ChangeEvent<HTMLInputElement | HTMLSelectElement>
  ) => Promise<void> | void;
}

const DocumentoVentaDetalle: React.FC<IProps> = ({
  dataGeneral,
  setDataGeneral,
  adicional,
  handleDataGeneral,
  ...
  const { porcentajesIGV }: IDocumentoVentaTablas =
    tablas || defaultDocumentoVentaTablas;
  const [articuloCompleto, setArticuloCompleto] = useState<IArticuloCompleto>(
    defaultArticuloCompleto
  );
  const [data, setData] = useState<IDocumentoVentaDetalle>(
    defaultDocumentoVentaDetalle
  );
  ...
  useEffect(() => {
    ...
    retorno &&
      ...
      handleActionBar(retorno as IDocumentoVentaDetalle);
  }, [retorno]);
  ...
  const handleActionBar = (detalle: IDocumentoVentaDetalle): void => {
  ...
  const handleClear = (): void => {
    ...
    setData(defaultDocumentoVentaDetalle);
    handleFocus(inputs["cantidad"]);
  };
  ...
  //#endregion
  return (
    <div className="form-base-container documento-venta-detalle-form">
...
export default DocumentoVentaDetalle;
