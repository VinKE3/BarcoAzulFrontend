...
import { useNotaPedidoDetalleColumn } from "../../../Column";
interface IProps {
...
const NotaPedidoDetalle: React.FC<IProps> = ({
  dataGeneral,
  setDataGeneral,
  adicional,
  handleDataGeneral,
  ...
  const [data, setData] = useState<INotaPedidoDetalle>(
    defaultNotaPedidoDetalle
  );
  ...
  useEffect(() => {
    ...
    retorno &&
      ...
      handleActionBar(retorno as INotaPedidoDetalle);
  }, [retorno]);
  ...
  const handleActionBar = (detalle: INotaPedidoDetalle): void => {
  ...
  const handleClear = (): void => {
    ...
    setData(defaultNotaPedidoDetalle);
    handleFocus(inputs["cantidad"]);
  };
...
export default NotaPedidoDetalle;
