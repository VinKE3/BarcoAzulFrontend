...
import { useGuiaRemisionDetalleColumn } from "../../../Column";

interface IProps {
  dataGeneral: IGuiaRemision;
  setDataGeneral: React.Dispatch<React.SetStateAction<IGuiaRemision>>;
  handleDataGeneral: (
    e: ChangeEvent<HTMLInputElement | HTMLSelectElement>
  ) => Promise<void> | void;
  adicional: IGuiaRemisionAdicional;
  handleAdicional: (
    e: ChangeEvent<HTMLInputElement | HTMLSelectElement>
  ) => Promise<void> | void;
}

const GuiaRemisionDetalle: React.FC<IProps> = ({
  dataGeneral,
  setDataGeneral,
  adicional,
  handleDataGeneral,
  ...
  const [data, setData] = useState<IGuiaRemisionDetalle>(
    defaultGuiaRemisionDetalle
  );

  const columns = useGuiaRemisionDetalleColumn(primer.tipo);
  ...
  useEffect(() => {
    ...
    retorno &&
      ...
      handleActionBar(retorno as IGuiaRemisionDetalle);
  }, [retorno]);
  ...
  const handleActionBar = (detalle: IGuiaRemisionDetalle): void => {
  ...
  return (
    <div className="form-base-container nota-pedido-detalle-form">
              ...
              <div className="input-base-container-100">
                ...
                <div className="input-base-container-button">
                  ...
                  <button
                    ...
                    disabled={
                      data.tipo === "consultar" || adicional.articuloVarios
                    }
      ...
      <Table
        ...
        selectable={false}
        border={true}
        tableClassName="nota-pedido-detalle-table"
      />
...
export default GuiaRemisionDetalle;
