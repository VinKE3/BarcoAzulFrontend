...
const UnidadMedidaFilter: React.FC = () => {
  //#region useState
  ...
  const [filter, setFilter] = useState<IUnidadMedidaFilter>(defaultUnidadMedidaFilter);
  ...
  const handleListar = async (): Promise<void> => {
    try {
      ...
      const { data, total }: { data: IUnidadMedidaTable[]; total: number } =
...
export default UnidadMedidaFilter;
