...
const SubLineaFilter: React.FC = () => {
  ...
  const [filter, setFilter] = useState<ISubLineaFilter>(defaultSubLineaFilter);
  ...
  const handleListar = async (): Promise<void> => {
    try {
      ...
      const { data, total }: { data: ISubLineaTable[]; total: number } =
