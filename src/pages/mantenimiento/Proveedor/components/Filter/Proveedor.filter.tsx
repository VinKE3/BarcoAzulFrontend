...
import { IProveedorFilter, IProveedorTable, defaultProveedorFilter } from "../../../../../models";
import { getListar, handleInputType, handleSetErrorMensaje, resetPagination } from "../../../../../util";

const ProveedorFilter: React.FC = () => {
  //#region useState
  ...
  const [filter, setFilter] = useState<IProveedorFilter>(defaultProveedorFilter);
  ...
  const handleListar = async (): Promise<void> => {
    try {
      ...
      const { data, total }: { data: IProveedorTable[]; total: number } = await getListar(globalContext, params);
  ...
  return (
    <div className="filter-base">
      ...
      <BasicKeyHandler selector="proveedor-filter">
        <div className="input-base-row proveedor-filter">
